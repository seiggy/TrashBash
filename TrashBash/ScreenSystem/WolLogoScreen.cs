...
namespace TrashBash.ScreenSystem
{
    ...
    /// </summary>
    internal class WolLogoScreen : GameScreen
    {
        private Texture2D _farseerLogoTexture;
        private Vector2 _origin;

        public WolLogoScreen()
        {
        ...
        {
            _farseerLogoTexture = ScreenManager.ContentManager.Load<Texture2D>("Content/SplashScreens/SPLASH");
