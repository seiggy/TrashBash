...
namespace TrashBash.ScreenSystem
{
    ...
    /// </summary>
    internal class QfaceLogoScreen : GameScreen
    {
        private Texture2D _farseerLogoTexture;
        private Vector2 _origin;

        public QfaceLogoScreen()
        {
        ...
        {
            _farseerLogoTexture = ScreenManager.ContentManager.Load<Texture2D>("Content/SplashScreens/QFACE_splash");
