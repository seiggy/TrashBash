...
namespace TrashBash.ScreenSystem
{
    public class PauseScreen : MenuScreen
    {
        ...
        public static bool allowRun = true;
        ...
        protected override void OnSelectEntry(int entryIndex)
        {
            ...
            {
                case 0:
                    if(PauseScreen.allowRun)
                        ExitScreen();
                    break;
                case 1:
                    SoundManager.PlayRandomSong();
                    MenuEntries[1] = "Current Song: " + MediaPlayer.Queue.ActiveSong.Artist + "-" + MediaPlayer.Queue.ActiveSong.Name;
                    break;
                case 2:
