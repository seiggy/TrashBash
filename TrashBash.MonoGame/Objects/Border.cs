...
using TrashBash.MonoGame.DrawingSystem;
...
namespace TrashBash.MonoGame.Objects
{
    public class Border
    {
        ...
        private void LoadBorderGeom(PhysicsSimulator physicsSimulator)
        {
            ...
            _borderGeom[0].CollisionGroup = 0;
            _borderGeom[0].Tag = "border";
