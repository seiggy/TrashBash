...
namespace TrashBash.MonoGame.ScreenSystem
{
    ...
    public abstract class GameScreen : IDisposable
    {
        ...
        {
            _physicsSimulator = new World(new Vector2(0, 0));
        ...
        public virtual void UpdatePhysics(GameTime gameTime, bool otherScreenHasFocus, bool coveredByOtherScreen)
        {
            if (!coveredByOtherScreen && !otherScreenHasFocus)
                PhysicsSimulator.Step(gameTime.ElapsedGameTime.Milliseconds * .001f);
        }
        ...
        {
            //Xbox
            if (input.P1LastGamePadState.Buttons.RightStick != ButtonState.Pressed && input.P1CurrentGamePadState.Buttons.RightStick == ButtonState.Pressed)
            {
